...
public class GroupSmsUtil {

    private static Logger logger = LoggerFactory.getLogger(GroupSmsUtil.class);

    public static boolean groupSms(String phone, String signName, String param) {
        // 设置超时时间-可自行调整
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAIOPRgoApJbJKo";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "SHsvSrNoYu2wxkyQZXU5azbXiikLbr";// 你的accessKeySecret，参考本文档步骤2
